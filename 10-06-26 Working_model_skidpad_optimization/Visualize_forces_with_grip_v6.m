function interactive_vehicle_viewer_pro
    ...
    white_col   = [1.00, 1.00, 1.00]; % Explicit white for HUDs
    ...
    % Trajectory HUD (Moved to the right of the track, colored white)
    traj_coord_hud = annotation(fig, 'textbox', [0.80 0.85 0.15 0.1], ...
    ...
    % Yaw Rate HUD (Moved to right side of vehicle pane, colored white)
