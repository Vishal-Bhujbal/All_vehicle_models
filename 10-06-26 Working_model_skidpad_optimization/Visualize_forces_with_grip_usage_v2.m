function interactive_vehicle_viewer_pro
    ...
    line_sep    = [0.30, 0.30, 0.35];  % Divider line color
    ...
    % UI SEPARATOR LINES
    % =========================================================================
    % Vertical Line separating left and right panes
    annotation(fig, 'line', [0.60 0.60], [0.10 0.95], 'Color', line_sep, 'LineWidth', 1.5);
    % Horizontal Line separating top right and bottom right plots
    annotation(fig, 'line', [0.60 0.97], [0.52 0.52], 'Color', line_sep, 'LineWidth', 1.5);

    % =========================================================================
    % AXES 1: TRAJECTORY (TOP RIGHT)
    % =========================================================================
    % Adjusted positioning to prevent overlap with the plot below it
    ax1 = axes('Position', [0.64 0.58 0.32 0.36]);
    ...
    % =========================================================================
    ax2 = axes('Position', [0.03 0.12 0.55 0.82]);
    ...
    yaw_text = text(ax2, 0.9, 1.25, '', 'Color', text_col, 'FontSize', 10, 'FontWeight', 'bold');
    
    % ZOOMED IN LIMITS to fix empty space
    ...
    ax3 = axes('Position', [0.64 0.12 0.32 0.36]);
    ...
    % =========================================================================
    timeline_ax = axes('Position', [0.05 0.03 0.70 0.04]);
    hold(timeline_ax, 'on');
    ...
    play_button = uicontrol('Style', 'togglebutton', 'String', 'PLAY', ...
        'Units', 'normalized', 'Position', [0.77 0.03 0.10 0.05], ...
    ...
    speed_menu = uicontrol('Style', 'popupmenu', ...
        ...
        'Value', 3, 'Units', 'normalized', 'Position', [0.88 0.03 0.10 0.05], ...
