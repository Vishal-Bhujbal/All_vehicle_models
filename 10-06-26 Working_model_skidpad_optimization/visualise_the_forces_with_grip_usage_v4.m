function interactive_vehicle_viewer_pro
    ...
    % --- NEW: Calculate Velocity for Radius of Curvature ---
    ...
    % Live Coordinate & Radius HUD
    traj_coord_text = text(ax1, 0.03, 0.95, '', 'Units', 'normalized', ...
        'Color', cyan_col, 'FontSize', 10, 'FontWeight', 'bold', ...
    ...
    function update_frame(idx)
        ...
        % --- NEW: Radius Calculation & HUD Update ---
        yr = abs(yaw_rate(idx));
        ...
        traj_coord_text.String = sprintf('X: %.2f m\nY: %.2f m\n%s', ...
